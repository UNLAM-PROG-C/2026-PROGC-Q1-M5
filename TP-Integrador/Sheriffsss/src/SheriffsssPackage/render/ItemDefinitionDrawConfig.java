...
public class ItemDefinitionDrawConfig
{
  ...
  private static final double BASE_ANGLE_DIAGONAL = 0.75;
  private static final double BASE_ANGLE_VERTICAL = 1.5;
  ...
  public ItemDefinitionDrawConfig()
  {
    ...
    this.baseAngle[index(Facing.UP_LEFT)] = BASE_ANGLE_DIAGONAL;
    this.baseAngle[index(Facing.RIGHT)] = 0.0;
    this.baseAngle[index(Facing.UP_RIGHT)] = -BASE_ANGLE_DIAGONAL;
    this.baseAngle[index(Facing.DOWN_LEFT)] = -BASE_ANGLE_DIAGONAL;
    this.baseAngle[index(Facing.DOWN_RIGHT)] = BASE_ANGLE_DIAGONAL;
    this.baseAngle[index(Facing.DOWN)] = BASE_ANGLE_VERTICAL;
    this.baseAngle[index(Facing.UP)] = -BASE_ANGLE_VERTICAL;
  }
