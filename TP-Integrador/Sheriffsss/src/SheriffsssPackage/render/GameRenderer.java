...
public class GameRenderer {
  ...
  private final TrainingHudRenderer trainingHudRenderer = new TrainingHudRenderer();
  ...
  private final Color healthyHpColor = new Color(50, 190, 50);
  private final Color lowHpColor = new Color(210, 50, 50);
  private final Color scoreColor = new Color(255, 220, 80);
  private final Color hintColor = new Color(200, 200, 200);
  private final Color fallbackPickupColor = new Color(220, 50, 50, 200);
  private final Color levelRewardColor = new Color(255, 210, 60);
  private final Color deathButtonColor = new Color(140, 20, 20);
  private final Color deathButtonBorderColor = new Color(220, 60, 60);
  ...
  private int weaponOriginCanvasY(GameView game) {
