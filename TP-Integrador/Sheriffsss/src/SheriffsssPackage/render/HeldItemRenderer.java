...
public class HeldItemRenderer
{
  ...
  public void drawToolTargetBar(Graphics2D g2, GameView game)
  {
    ...
    int screenX = this.camera.tileToScreenX(targetObject.getRootTileX()) + objectWidth / GlobalConstants.DIVISOR_HALF - barWidth / GlobalConstants.DIVISOR_HALF;
  ...
  public void applyHeldItemRotation(Graphics2D g2, ItemDefinitionDrawConfig drawConfig, Facing facing, int drawX, int drawY,
    ...
    {
    double centerX = drawX + itemWidth / (double) GlobalConstants.DIVISOR_HALF;
    double centerY = drawY + itemHeight / (double) GlobalConstants.DIVISOR_HALF;
    if (recoilAngle != 0.0)
    {
